...
#define VENDOR_NAME                "ACPAD"
#define PRODUCT_NAME               "chromatic"
#define VOLUME_LABEL               PRODUCT_NAME
#define INDEX_URL                  "https://acpad.com/#" PRODUCT_NAME
#define BOARD_ID                   "versioduo:samd:acpad-" PRODUCT_NAME

#define USB_VID                    0x6666
#define USB_PID                    0xdf60
